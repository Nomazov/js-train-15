...
function calculateCircleArea(radius) {
    ...
    if (isNaN(radius)) {
        console.log("Error: radius is not a number")
        return null;
    };
...
function findMinMax(numbers) {
    ...
    if (!Array.isArray(numbers)) {
        console.log("Error: numbers is not Array")
        return null;
    };
...
function calculateHypotenuse(a, b) {
    ...
    if (typeof a !== "number" || typeof b !== "number") {
        console.log("Error: a & b is not a number")
        return null;
    };
...
function roundObjectValues(obj) {
    ...
    const roundValues = entries.map(([key, value]) => {
    ...
    return Object.fromEntries(roundValues);
...
function calculateVolumeCylinder(radius, height) {
    ...
    if (typeof radius !== "number" || typeof height !== "number") {
        console.log("Error: radius or(and) height is not a number")
        return null;
    };
